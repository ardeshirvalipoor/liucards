...
function listCards(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const { user_id, device_id, limit, before, dueOnly = false, includeArchived = false } = params;
        ...
        try {
            ...
            const mappedCards = (data !== null && data !== void 0 ? data : []).map(row => {
                const typedRow = Object.assign(Object.assign({}, row), { cards: Array.isArray(row.cards) ? row.cards[0] : row.cards });
...
function mapSavedCard(row, user_id, deviceId) {
