...
function getQueue(userId, limit, includeNew) {
...
function submit(userId, body) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nextIntervalDays = Math.max(1, (_a = nextCard.scheduled_days) !== null && _a !== void 0 ? _a : 1);
        const nextDue = nextCard.due.toISOString();
        // 3) Append review log
        const reviewedAt = (_b = body.client_reviewed_at) !== null && _b !== void 0 ? _b : new Date().toISOString();
